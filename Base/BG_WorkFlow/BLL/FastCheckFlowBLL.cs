...
namespace BG_WorkFlow
{
    public class FlowBLL
    {
        ...
        public FlowBLL(ControlVersion controlVersion)
        {
        ...
        {
            return SystemDirectoryConfig.GetInstance().GetFlowConfig(controlVersion);
        }
    ...
    public class RepairBLL
    {
        ...
        public RepairBLL(ControlVersion controlVersion)
        {
            ConfigDataModelList = GetCarBoostSettingConfigDataModel(GetPath(controlVersion));
        }
        ...
        private string GetPath(ControlVersion controlVersion)
        {
            return SystemDirectoryConfig.GetInstance().GetRepairConfig(controlVersion);
        }
