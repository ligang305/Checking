...
namespace BG_WorkFlow
{
    ...
    {
        private List<BG_BGV6000BS> bsList = new List<BG_BGV6000BS>();
        ...
        /// </summary>
        /// <returns></returns>
        public List<BG_BGV6000BS> GetBSModel()
        {
            bsList = BGV6000BSDal.GetBg_BsFromDataBase();
            return bsList;
        }
        ...
        /// <returns></returns>
        public bool SaveBSModel(BG_BGV6000BS _TBGV6000BSModel)
        {
        ...
        /// <param name="_TDoseModel"></param>
        /// <returns></returns>
        public bool InsertBSModel(BG_BGV6000BS _TBGV6000BSModel)
        {
        ...
        /// <param name="_TDoseModel"></param>
        /// <returns></returns>
        public bool DeleteBSModel(BG_BGV6000BS _TBGV6000BSModel)
        {
