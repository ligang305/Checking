...
namespace BGUserControl
{
    ...
    [CustomExportMetadata(1, Modules.BSFlowSettingModule, "阈值设置", "ZZW", "1.0.0")]
    public class BS_FlowSetting: BSBaseModules
    {
        ...
        BSFlowSettingMvvm flowSettingMvvm = new BSFlowSettingMvvm();
        bool? isVisible = false;
        [ImportingConstructor]
        public BS_FlowSetting() : base(ControlVersion.BS)
        {
        ...
        private Grid InitGrid()
        {
            ...
            {
                int index = flowSettingMvvm.CommonSettingModelList.IndexOf(CommonSetting)  + 1;
        ...
        /// <param name="e"></param>
        private async void TsBtn_UnChecked(object sender, RoutedEventArgs e)
        {
            CommonSettingModel Model = (sender as ToggleSwitchButton).Tag as CommonSettingModel;
            Model.CommonSettingValue = "0";
            await SendToggleButtonCommand(sender, Model);
        }
        /// <summary>
        /// 发送ToggleButton指令
        /// </summary>
        /// <param name="Model"></param>
        private async Task SendToggleButtonCommand(object sender, CommonSettingModel Model)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private async void TsBtn_Checked(object sender, RoutedEventArgs e)
        {
            CommonSettingModel Model = (sender as ToggleSwitchButton).Tag as CommonSettingModel;
    ...
    public class BSFlowSettingMvvm : BaseMvvm
    {
        ...
        private void InitListData()
        {
            ...
            FFB.GetCarBoostSettingConfigDataModel(SystemDirectoryConfig.GetInstance().GetFlowConfig(ControlVersion.BS)).ForEach(q => CommonSettingModelList.Add(q));
        }
        ...
        {
            FFB.SaveConfigDataModel(CommonSettingModelList, ControlVersion.BS);
        }
