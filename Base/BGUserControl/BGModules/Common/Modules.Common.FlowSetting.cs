...
namespace BGUserControl
{
    ...
    public class FlowSetting: BaseModules
    {
        ...
        private Grid InitGrid()
        {
            ...
            {
                int index = flowSettingMvvm.CommonSettingModelList.IndexOf(CommonSetting)  + ((!ConfigServices.GetInstance().localConfigModel.IsLogin || CurrentRole.Equals("jjAdmin")) ? 2 : 1);
