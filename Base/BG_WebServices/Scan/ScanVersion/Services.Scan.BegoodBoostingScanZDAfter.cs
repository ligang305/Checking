...
namespace BG_Services
{
    ...
    [CustomExportMetadata(1, "BegoodBoostingScanZDAfter", "CGN. Begood", "zhuzhiwu", "1.0.0")]
    public class BegoodBoostingScanZDAfter : BaseScan
    {
        ...
        private void InitiaRecv(CallBackParamaterAction _object)
        {
            RequestTaskAction();
