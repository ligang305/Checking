...
{
    [Description("自行走服务接口")]
    [Export(nameof(SelfAutoWorkingPLCProtocol), typeof(PLCProtocol))]
    public class SelfAutoWorkingPLCProtocol : PLCV500Protocol
    {
        public SelfAutoWorkingPLCProtocol()
        {
            ProtocolName = "Control station-self-walking PLC protocol";
