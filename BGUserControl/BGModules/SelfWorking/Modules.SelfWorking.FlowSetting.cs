...
namespace BGUserControl
{
    ...
    [CustomExportMetadata(1, "SelfWorking_FlowSetting", "流程及模式设置", "ZZW", "1.0.0")]
    public class SelfWorking_FlowSetting : BaseModules
    {
        ...
        FlowBLL FFB = new FlowBLL(ControlVersion.SelfWorking);
        ObservableCollection<CommonSettingModel> CommonSettingModelList = new ObservableCollection<CommonSettingModel>();
        [ImportingConstructor]
        public SelfWorking_FlowSetting() : base(ControlVersion.FastCheck)
        {
            Loaded += SelfWorking_FlowSetting_Loaded; 
            Unloaded += SelfWorking_FlowSetting_Unloaded;
        }

        private void SelfWorking_FlowSetting_Unloaded(object sender, System.Windows.RoutedEventArgs e)
        {
            try
            {
                this.Close();
        ...
        private void SelfWorking_FlowSetting_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
        ...
        private void MakeToggleButtonList(CommonSettingModel _csm, Grid _dp, Label btnInner)
        {
            ...
            {
                tsBtn.IsChecked = GlobalRetStatus[18] ? GlobalRetStatus[18] : GlobalRetStatus[17];
        ...
        private void BtnSendCommand_PreviewMouseUp(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            try
            {
                ...
                //if (isSendSuccess)
                //{
                    FFB.SaveConfigDataModel(CommonSettingModelList,cv);
                //}
        ...
        private void BtnSetting_PreviewMouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            BuryingPoint($"Setting Frence{cbx.SelectedValue.ToString()}");
