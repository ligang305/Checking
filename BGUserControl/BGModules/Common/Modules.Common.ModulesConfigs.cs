...
namespace BGUserControl
{
    ...
    [CustomExportMetadata(1, Modules.ModulesConfigModule, "模块配置", "ZZW", "1.0.0")]
    public class ModulesConfigModule : BaseModules
    {
        ...
        ModulesConfigMvvm modulesConfigMvvm;
        public ModulesConfigModule(): base(Common.controlVersion)
        {
            Loaded += ModulesConfigModule_Loaded;
        }
        ...
        {
            modulesConfigMvvm = new ModulesConfigMvvm(Common.controlVersion);
        ...
        /// <param name="e"></param>
        private void ModulesConfigModule_Loaded(object sender, System.Windows.RoutedEventArgs e)
        {
            InitContent();
            InitAction();
        }
        ...
        {
            ModulesConfigModule_Loaded(null, null);
        }
        /// <summary>
        /// 切换语言
        /// </summary>
