    ...
    public class FastCheck_FlowSetting: BaseModules
    {
        ...
        private Grid InitGrid()
        {
            ...
            foreach (CommonSettingModel CommonSetting in CommonSettingModelList)
            {
                ...
                int index = CommonSettingModelList.IndexOf(CommonSetting) + ((!ConfigServices.GetInstance().localConfigModel.IsLogin || (CurrentRole != null && CurrentRole.Equals("jjAdmin"))) ? 2 : 1);
